...
@DisplayName("Test: 22. Generate Parentheses.")
public class SolutionTest {
    ...
    private static final String SOURCE_FILE = "problem0022.json";
    ...
    public void runTestCases(TestCase testCase) {
        ...
        List<String> actual = Solution.generateParenthesis(testCase.getN());
