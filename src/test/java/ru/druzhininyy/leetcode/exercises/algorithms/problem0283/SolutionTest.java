...
@DisplayName("Test: 283. Move Zeroes.")
public class SolutionTest {
    ...
    private static final String SOURCE_FILE = "problem0283.json";
    ...
    public void runTestCases(TestCase testCase) {
        ...
        Solution.moveZeroes(testCase.getNums());

        assertThat(testCase.getNums(), is(testCase.getExpected().get(0)));
    }
