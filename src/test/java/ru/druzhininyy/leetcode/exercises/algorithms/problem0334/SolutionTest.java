...
@DisplayName("Test: 334. Increasing Triplet Subsequence.")
public class SolutionTest {
    ...
    private static final String SOURCE_FILE = "problem0334.json";
    ...
    public void runTestCases(TestCase testCase) {
        ...
        var actual = Solution.increasingTriplet(testCase.getNums());
