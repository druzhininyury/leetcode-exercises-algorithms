...
@DisplayName("Test: 345. Reverse Vowels of a String.")
public class SolutionTest {
    ...
    private static final String SOURCE_FILE = "problem0345.json";
    ...
    public void runTestCases(TestCase testCase) {
        ...
        var actual = Solution.reverseVowels(testCase.getStr());
