...
@DisplayName("Test: 605. Can Place Flowers.")
public class SolutionTest {
    ...
    public static class TestCase {
        public int[] flowerbed;
        public int n;
        public List<Boolean> expected;
    }

    private static final String SOURCE_FILE = "problem0605.json";
    ...
    public void runTestCases(TestCase testCase) {
        ...
        var actual = Solution.canPlaceFlowers(testCase.getFlowerbed(), testCase.getN());
