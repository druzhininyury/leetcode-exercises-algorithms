...
@DisplayName("Test: 1071. Greatest Common Divisor of Strings.")
public class SolutionTest {
    ...
    private static final String SOURCE_FILE = "problem1071.json";
    ...
    public void runTestCases(TestCase testCase) {
        ...
        var actual = Solution.gcdOfStrings(testCase.getStr1(), testCase.getStr2());
