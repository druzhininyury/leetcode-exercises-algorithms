...
@DisplayName("Test: 1768. Merge Strings Alternately.")
public class SolutionTest {
    ...
    private static final String SOURCE_FILE = "problem1768.json";
    ...
    public void runTestCases(TestCase testCase) {
        ...
        var actual = Solution.mergeAlternately(testCase.word1, testCase.word2);
